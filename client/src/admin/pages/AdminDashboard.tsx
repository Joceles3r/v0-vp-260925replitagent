...
import { LivresQueueManagement } from "../components/LivresQueueManagement"
...
export default function AdminDashboard() {
  ...
  return (
    <AdminLayout>
      <div
        id="overview"
        className="rounded-2xl border border-fuchsia-500/30 p-5 bg-gradient-to-b from-fuchsia-500/5 to-transparent"
      >
...
function Stat({ label, value, testId }: { label: string; value: string | number; testId?: string }) {
  return (
    <div className="rounded-xl border border-fuchsia-500/30 p-4 bg-black/40">
      ...
      <div className="text-2xl font-bold mt-1" data-testid={testId}>
        {value}
      </div>
    </div>
  )
