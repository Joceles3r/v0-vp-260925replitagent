...
export default function Navigation() {
  ...
  const navItems = [
    ...
    { path: "/livres", label: "📚 Livres", section: "livres", highlight: true },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
            ...
            <div className="flex-shrink-0">
              <Link href="/dashboard" className="flex items-center gap-3 group" data-testid="logo-link">
                ...
                <div className="ml-1">
                  ...
                  <span className="text-[10px] text-muted-foreground font-medium tracking-tight hidden lg:block">
          ...
          <div className="flex items-center space-x-4">
            <Link
              href="/profile"
              className="flex items-center space-x-3 px-3 py-1.5 rounded-lg glass-card smooth-transition hover:border-[#7B2CFF]/50 hover:neon-glow-violet"
            ...
            >
              ...
              <div className="hidden lg:block">
                ...
                {user?.kycVerified && (
                  <div
                    className="text-xs bg-gradient-to-r from-green-500/20 to-green-400/20 text-green-400 px-2 py-0.5 rounded-full inline-flex items-center mt-0.5"
